...
const IncomeTableHeader: React.FC<IncomeTableHeaderProps> = ({ sort, onSortChange }) => {
  ...
  const sortableFields: { field: SortState['field']; label: string; width: string }[] = [
    ...
    { field: 'source', label: 'מקור', width: 'w-32' },
    { field: 'month', label: 'חודש', width: 'w-20' },
    { field: 'year', label: 'שנה', width: 'w-20' },
