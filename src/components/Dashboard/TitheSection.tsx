...
const TitheSection: React.FC<TitheSectionProps> = ({ totalIncome, tithePercentage, titheGiven, onAddTithe }) => {
  ...
  return (
    <>
      <div className="bg-white rounded-xl shadow-sm p-5 border-r-4 border-pink-400 hover:shadow-md transition-all duration-300" style={{ maxHeight: '500px', overflow: 'hidden' }}>
