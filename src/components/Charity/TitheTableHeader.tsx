...
interface TitheTableHeaderProps {
  sort: SortState;
  onSortChange: (field: SortState['field']) => void;
}

const TitheTableHeader: React.FC<TitheTableHeaderProps> = ({ sort, onSortChange }) => {
  ...
  const sortableFields: { field: SortState['field']; label: string; width: string }[] = [
    ...
    { field: 'description', label: 'תיאור', width: 'w-64' },
  ...
  return (
    <thead className="bg-gray-50 sticky top-0 z-30">
      <tr>
        ...
        <th className="w-48 px-3 py-2 text-right text-xs font-medium text-gray-500 uppercase tracking-wider">
          הערה
        </th>
...
export default TitheTableHeader;